    ...
    <div id="page" class="container">
        ...
        <form method="POST" action="/articles">
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea @error('excerpt') is-danger @enderror" type="text" name="excerpt"
            ...
            <div class="field">
                ...
                <div class="control">
                    <textarea class="textarea @error('body') is-danger @enderror" type="text" name="body"
